...
object IanaUnicastV6 {
  ...
  val GLOBAL_UNICAST_V6 = toRecords(List(List("iana", "ZZ", "ipv6") ++ toPrefixLength("2000::/3") ++ List(IPV6_IANA_POOL_DATE, "available", "iana", "iana")))
  // Except for the first /16 of global unicast, to be included as reserved for IETF
  val FIRST_SLASH_16_UNICAST_V6 = toRecords(List(List("iana", "ZZ", "ipv6") ++ toPrefixLength("2000::/16") ++ List(IPV6_IANA_POOL_DATE, "reserved", "ietf", "iana")))
